...
var _jsxFileName = "/home/cristi/Desktop/projects/wedding-application/app/javascript/packs/weddings.jsx";
...
function (_Component) {
  ...
  _createClass(Weddings, [{
    ...
    value: function toggleSelectedUser(e) {
      ...
      $.ajax({
        url: "toggle_user?user_id=".concat(userId),
        dataType: 'json',
        method: 'PUT'
      }).done(function (data) {
        console.log(data);
...
document.addEventListener('DOMContentLoaded', function () {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Weddings, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 69
    },
...
/******/ });
//# sourceMappingURL=weddings-e5a67885be89fdaa47e6.js.map